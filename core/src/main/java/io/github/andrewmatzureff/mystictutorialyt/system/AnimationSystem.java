...
import io.github.andrewmatzureff.mystictutorialyt.component.Facing;
...
public class AnimationSystem extends IteratingSystem {
    ...
    protected void processEntity(Entity entity, float deltaTime) {
        ...
        if (animation2D.isDirty() || facingDirection != animation2D.getDirection()) {
            ...
            stateTime = 0f;
        } else stateTime = animation2D.incAndGetStateTime(deltaTime);
        ...
        Graphic.MAPPER.get(entity).setTextureRegion(keyFrame);
    }
    ...
    public record CacheKey(AtlasAsset atlasAsset, String assetKey, Animation2D.AnimationType type, Facing.FacingDirection direction) {}
}
